  ...
  return (
    <section className="py-12 px-4 max-w-7xl mx-auto text-white">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            {!show360 && (
              <>
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-14 h-14 rounded-full bg-[#1a1a1d]/70 hover:bg-[#2a2a2a]/70 backdrop-blur-md flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 shadow-lg border border-purple-800 hover:shadow-purple-500/50"
                >
                  <svg
                    className="w-7 h-7 text-purple-400 cursor-pointer"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-14 h-14 rounded-full bg-[#1a1a1d]/70 hover:bg-[#2a2a2a]/70 backdrop-blur-md flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 shadow-lg border border-purple-800 hover:shadow-purple-500/50"
                >
                  <svg
                    className="w-7 h-7 text-purple-400 cursor-pointer"
                    fill="none"
        ...
        {/* Car Details */}
        <div className="bg-[#1a1a1d]/90 p-8 rounded-3xl border border-purple-900 shadow-[0_0_60px_rgba(124,58,237,0.15)] h-fit sticky top-32">
          ...
          <div className="space-y-3">
            <button className="w-full py-4 px-6 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-xl font-bold hover:shadow-2xl hover:shadow-purple-500/60 transition-all shadow-lg hover:scale-[1.02] active:scale-95 text-lg cursor-pointer">
              Get Loan Quote
            </button>
            <button className="w-full py-4 px-6 bg-[#1a1a1d]/70 text-purple-300 rounded-xl font-bold hover:bg-[#2a2a2a] transition-all border border-purple-800 hover:border-purple-500 text-lg cursor-pointer">
              Schedule Test Drive
            </button>
          </div>

          {/* EMI Calculator embedded */}
          {/* <div className="mt-10">
...
// Import EMICalculator at the top of the file
